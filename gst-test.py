...
CLI='flvmux name=mux streamable=true ! rtmpsink location="'+ RTMP_SERVER +'" sync=true \
    ...
    osxaudiosrc device=87 do-timestamp=true ! audioconvert ! audioresample ! audio/x-raw, format=S16LE, rate=16000, channels=1, channel-mask=(bitmask)0x1 ! faac bitrate=48000 ! audio/mpeg ! aacparse ! audio/mpeg, mpegversion=4 ! queue ! mux.'
